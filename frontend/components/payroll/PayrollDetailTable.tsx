...
export function PayrollDetailTable({
    ...
    const EmployeeDetailRow = ({ detail }: { detail: PayrollDetail }) => (
        <TableRow>
            <TableCell colSpan={9} className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-0 border-0">
                        ...
                        <div>
                            ...
                            <div className="space-y-2 text-sm">
                                ...
                                <div className="flex justify-between py-1">
                                    ...
                                    <span className="font-medium">{formatCurrency((detail as any).pokokTrm || detail.baseSalary)}</span>
                                </div>
                                <div className="flex justify-between py-1">
                        ...
                        {filteredDetails.length === 0 ? (
                            ...
                            paginatedDetails.map((detail) => (
                                <React.Fragment key={detail.id}>
                                    ...
                                    {expandedRows.has(detail.id) && <EmployeeDetailRow detail={detail} />}
                                </React.Fragment>
                            ))
                        )}
                    </TableBody>
