    ...
    return (
        <>
                            ...
                            {isAuth && (
                                <>
                                    ...
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-full bg-gradient-to-r from-sky-400 to-emerald-500 flex items-center justify-center text-white font-semibold shadow-lg">
            ...
            `}>
                ...
                {/* Menu Panel */}
                <div className={`
                    absolute top-20 right-4 w-80 bg-white dark:bg-gray-900 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-800 overflow-hidden transition-all duration-300
                    ${mobileMenuOpen
                ...
                `}>
                    {isAuth ? (
                        <>
                            ...
                            <div className="p-6 bg-gradient-to-r from-sky-50 to-emerald-50 dark:from-gray-800 dark:to-gray-900 border-b border-gray-100 dark:border-gray-800">
                                <div className="flex items-center gap-4">
                                    <div className="w-14 h-14 rounded-full bg-gradient-to-r from-sky-400 to-emerald-500 flex items-center justify-center text-white font-bold text-xl shadow-lg">
                                        {user ? getUserInitials() : 'U'}
                                    </div>
                                    <div>
                                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                            ...
                            <div className="p-4">
                                    ...
                                    {navItems.map((item) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <span className="font-medium">{item.name}</span>
                                                {isActive && (
                                                    <div className="ml-auto w-2 h-2 bg-sky-500 dark:bg-sky-400 rounded-full"></div>
                                                )}
                                            </Link>
                                        );
                                    })}
                                ...
                                <div className="space-y-1">
                                    ...
                                    <div className="pt-2">
                                        <LogoutButton
                                            className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-sky-500 to-emerald-500 text-white font-semibold rounded-lg hover:shadow-lg transition-all duration-300 hover:scale-[1.02]"
                                        />
                                    </div>
                                </div>
                            </div>
                        ...
                        // Not authenticated state - Mobile
                        <div className="p-6">
