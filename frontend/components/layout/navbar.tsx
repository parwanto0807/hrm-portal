                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex lg:hidden items-center gap-3">
                            ...
                            >
                                {isDarkMode ? (
                                    <svg className="w-6 h-6" fill="none" viewBox="0 0 26 26" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
                                    </svg>
                                ) : (
                                    <svg className="w-6 h-6" fill="none" viewBox="0 0 26 26" stroke="currentColor">
                            ...
                            {isAuth && (
                                <>
                                    ...
                                    <div className="flex items-center gap-3">
                                        <div className="relative md:w-10 md:h-10 w-8 h-8 rounded-full overflow-hidden bg-gradient-to-r from-sky-400 to-emerald-500 flex items-center justify-center text-white font-semibold shadow-lg">
