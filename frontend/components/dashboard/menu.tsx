      ...
      <TooltipTrigger asChild>
        <Button
          ...
          className={cn(
            ...
            isOpen ? "w-full justify-start rounded-lg px-3" : "w-10 justify-center rounded-lg p-0 mx-auto",
            theme === 'dark' && cn(
              active
                ? "bg-gradient-to-br from-cyan-500 via-blue-500 to-purple-600 text-white shadow-lg shadow-cyan-500/20"
                : cn(
                  "bg-gray-900/60 text-gray-400 backdrop-blur-md",
                  "border border-green-500/20 hover:border-green-400/50", // Border berwarna Cyan tipis
            ...
            theme === 'light' && cn(
              active
                ...
                : cn(
                  "bg-white/60 text-gray-500 backdrop-blur-md",
                  "border border-green-200 hover:border-green-400/60", // Border berwarna Blue tipis
                  "hover:bg-white/90 hover:text-cyan-700 shadow-sm transition-all duration-300"
                ),
      ...
      {!isOpen && (
        <TooltipContent
          ...
          className={cn(
            ...
            "z-[100] px-2 py-1.5 rounded-lg text-xs shadow-lg border"
          )}
        >
    ...
    <Tooltip delayDuration={100}>
      ...
      {!isOpen && (
        <TooltipContent
          ...
          className={cn(
            theme === 'dark' ? "bg-gray-800 text-white border-gray-700" : "bg-white text-gray-800 border-gray-200",
            "z-[100] max-w-xs px-2 py-1.5 rounded-lg text-xs shadow-lg border"
          )}
        >
          {label}
        </TooltipContent>
      ...
      <TooltipProvider>
        <Tooltip delayDuration={100}>
          ...
          <TooltipContent
            ...
            className={cn(
              theme === 'dark' ? "bg-gray-800 text-white border-gray-700" : "bg-white text-gray-800 border-gray-200",
              "z-[100] px-2 py-1.5 rounded-lg text-xs font-medium border"
            )}
          >
                          ...
                          <Popover>
                            ...
                            <PopoverContent
                              ...
                              className={cn(
                                ...
                                "w-56 p-2 shadow-xl border rounded-lg",
                                "z-[100]"
                              )}
                            >
