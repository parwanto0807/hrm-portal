          ...
          <TooltipTrigger asChild>
            <DropdownMenuTrigger asChild>
              <Button
                variant={active ? "default" : "ghost"}
                className={cn(
                  "h-10 transition-all duration-300 mb-1 hover:bg-gradient-to-r from-blue-500 via-blue-400 to-blue-300 hover:text-white",
                  isOpen === false ? "w-10 justify-center p-0 mx-auto" : "w-full justify-start",
